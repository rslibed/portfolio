$(document).ready(function() {
  ...
  if ($(window).scrollTop() < 20) {
    $('.custom-navbar-brand').css('display', 'none');
  } else {
    $('.custom-navbar-brand').css('display', 'block');
  }
  ...
  $('.project-nav .next-project').click(function() {
    ...
    $('#project-viewer .container').fadeOut(500, function() {
  ...
  function afterLoadFn() {
    ...
    if ($('.project-item.active').index() == 0) {
      $('#project-viewer .previous-project').addClass('hidden');
    } else {
      $('#project-viewer .previous-project').removeClass('hidden');
    }

    if ($('.project-item.active').index() == $('.project-item').length - 1) {
      $('#project-viewer .next-project').addClass('hidden');
    } else {
      $('#project-viewer .next-project').removeClass('hidden');
    }
